...
print("Mesh dir exists:", os.path.exists(opt.mesh_dir))
print("Mesh dir contains:", os.listdir(opt.mesh_dir))
...
if opt.mesh_fpath and opt.split_name and opt.object_name:
    ...
    cam_locations = util.get_archimedean_spiral(sphere_radius, 32)
